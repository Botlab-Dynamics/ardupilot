...
#define PROBE_MAG_IMU_I2C(driver, imudev, bus, addr, args ...) ADD_BACKEND(DRIVER_ ##driver, AP_Compass_ ## driver::probe_ ## imudev(GET_I2C_DEVICE(bus,addr),##args))
    ...
    * 240x240 crop rescaled to 64x64 */
    ...
    #define HAL_GPIO_A_LED_PIN 67
    #define HAL_GPIO_B_LED_PIN 66
    #define HAL_GPIO_LED_ON    1
    #define HAL_GPIO_LED_OFF   0
    ...
    #define HAL_MAG_PROBE1 PROBE_MAG_IMU_I2C(AK8963, mpu9250, 2, 0x0c, ROTATION_NONE)
    #define HAL_MAG_PROBE2 PROBE_MAG_I2C(AK8963, 1, 0x0e, ROTATION_NONE)
    #define HAL_MAG_PROBE_LIST HAL_MAG_PROBE1; HAL_MAG_PROBE2
    #define HAL_PROBE_EXTERNAL_I2C_COMPASSES
    #define HAL_OPTFLOW_PX4FLOW_I2C_BUS 1
    #define HAL_RANGEFINDER_LIGHTWARE_I2C_BUS 1
    #define HAL_NUM_CAN_IFACES 1
#elif CONFIG_HAL_BOARD_SUBTYPE == HAL_BOARD_SUBTYPE_LINUX_BBAI64
    #define HAL_GPIO_A_LED_PIN 67
    #define HAL_GPIO_B_LED_PIN 66
    #define HAL_GPIO_LED_ON    1
    #define HAL_GPIO_LED_OFF   0
